...
cartridj.enter((ctx) => {
    try {
        ctx.reply(texts.Cartridj_Choose, {
            reply_markup: {
                keyboard: [
                    [`JUUL: ${config.prices.juul} руб.`],
                    [`LOGIC: ${config.prices.logic} руб.`],
                    [texts.Return_Button]
                ],
                resize_keyboard: true
            }
...
cartridj.hears(`JUUL: ${config.prices.juul} руб.`, (ctx) => {
    try {
...
cartridj.hears(`LOGIC: ${config.prices.logic} руб.`, (ctx) => {
    try {
...
hqd.enter((ctx) => {
    try {
        ctx.reply(texts.HQD_Choose, {
            reply_markup: {
                keyboard: [
                    [`CUVIE (350 тяг): ${config.prices.cuvie} руб`, ],
                    [`MAXIM (400 тяг): ${config.prices.maxim} руб`],
                    [`ROSY (500 тяг): ${config.prices.rosy} руб`],
                    [`ULTRA (500 тяг): ${config.prices.ultra} руб`],
                    [`CUVIE PLUS (1200 тяг): ${config.prices.cuvie_plus} руб`],
                    [texts.Return_Button]
                ],
                resize_keyboard: true
            }
...
hqd.hears(`CUVIE (350 тяг): ${config.prices.cuvie} руб`, (ctx) => {
    try {
...
hqd.hears(`MAXIM (400 тяг): ${config.prices.maxim} руб`, (ctx) => {
    try {
...
hqd.hears(`ULTRA (500 тяг): ${config.prices.ultra} руб`, (ctx) => {
    try {
...
hqd.hears(`ROSY (500 тяг): ${config.prices.rosy} руб`, (ctx) => {
    try {
...
hqd.hears(`CUVIE PLUS (1200 тяг): ${config.prices.cuvie_plus} руб`, (ctx) => {
    try {
